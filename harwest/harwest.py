...
def build_argument_parser():
    ...
    subparsers = parser.add_subparsers(help="The platform to scrape the solutions from")
...
def init():
    ...
    print(
        ...
        os.getcwd() + os.path.sep + "<your-input>",
    )
    ...
    if os.path.exists(path):
        print(
            "\U000026a0",
            "WARNING! The directory with the path",
            path,
            "already exists.\n",
    ...
    if args.init or config_map is None:
        if config_map is None:
            print(
                "Hey there!",
                "\U0001f44b",
                "Looks like you're using Harwest for the first time. Let's get you started",
                "\N{ROCKET}",
                "\n",
            )
        init()
